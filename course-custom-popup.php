...
function ccp_render_settings_page()
{
    if (isset($_POST['ccp_save_settings'])) {
        ...
        // Add new conditional form shortcode setting
        if (isset($_POST['ccp_conditional_form_shortcode'])) {
            update_option('ccp_conditional_form_shortcode', sanitize_text_field($_POST['ccp_conditional_form_shortcode']));
        }
    ...
    $conditional_form_shortcode = get_option('ccp_conditional_form_shortcode', 'conditional-bookly-form');
    ?>
        <div class="wrap">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">Enter the shortcode name without brackets (e.g., appointment-status-check)
                        </p>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <p class="description">Enter the shortcode name for the return button (e.g., return-to-dashboard)
                        </p>
                    </td>
                </tr>
                <tr>
                    <th scope="row">
                        <label for="ccp_conditional_form_shortcode">Conditional Form Shortcode</label>
                    </th>
                    <td>
                        <input type="text" id="ccp_conditional_form_shortcode" name="ccp_conditional_form_shortcode"
                            value="<?php echo esc_attr($conditional_form_shortcode); ?>" class="regular-text">
                                <p class="description">Enter the shortcode name for the conditional Bookly form (e.g.,
                                    conditional-bookly-form)
                                </p>
                            </td>
                        </tr>
                        </table>
                        <p class="submit">
                <input type="submit" name="ccp_save_settings" class="button button-primary" value="Save Settings">
            </p>
        </form>
    </div>
    <?php
...
require_once plugin_dir_path(__FILE__) . 'shortcodes/conditional-bookly-form.php';
...
function initialize_shortcodes()
{
    ...
    CCP_Conditional_Bookly_Form_Shortcode::get_instance(); // Add this line
}
